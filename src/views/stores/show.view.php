...
<main class="mainContent row-grid container p-3 d-flex">
    <form class="col-6 form form--black" method="POST" action="/stores/create">
        <div class="row form--w100 d-flex row-flex g-1">
            <div class="column-flex form__inputContainer align-start">
                <label class="form-label " for="name">Nazwa</label>
                <input class="form-control" required id="name" name="name" type="text" value="<?= htmlspecialchars($storeData[0]['name'] ?? '', ENT_QUOTES, 'UTF-8') ?>"">
            </div>
            <div class=" column-flex form__inputContainer align-start">
